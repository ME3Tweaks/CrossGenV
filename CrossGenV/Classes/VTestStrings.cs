    ...
    internal class VTestStrings
    {
        ...
        [
            ...
            new()
            {
                StringID = 338474,
                INT = "XP on 1st Place",
                ESN = "Puntos de experiencia en el 1er puesto",
            ...
            new()
            {
                ...
                ESN = "Se te concederá experiencia al conseguir el 1er puesto en un mapa de simulador. Se otorgará 1/3 de los puntos de experiencia de un nivel al conseguir el 1er puesto por primera vez en cada mapa de simulador. Se concederán puntos de experiencia adicionales al batir tu récord y al completar el escenario especial.",
            ...
            new()
            {
                ...
                ESN = "La cantidad de enemigos que aparecen será como en la versión original.",
            ...
            new()
            {
                ...
                ESN = "Los enemigos no ganarán modificaciones de armas a medida que avancen las misiones del simulador. Este es el valor por defecto.",
            ...
            new()
            {
                ...
                ESN = "Selecciona el tipo de enemigo",
            ...
            new()
            {
                ...
                ESN = "Este tipo de enemigo no está activado actualmente.",
            ...
            new()
            {
                ...
                DEU = "Alle Einstellungen: Empfohlen",
            ...
            new()
            {
                ...
                ESN = "Los tipos de enemigo no cambiarán respecto a los predeterminados.",
            ...
            new()
            {
                ...
                ESN = "Se han modificado los tipos de enemigo predeterminados.",
            ...
            new()
            {
                StringID = 338550,
                INT = "Score to beat: %1",
                ESN = "Puntuación a batir:",
                DEU = "Zu schlagender Punktestand:",
                FRA = "",
                ITA = "",
                RUS = "Рекорд:",
                POL = "",
